...
(function() {
  ...
  Cartograph = (function() {
    ...
    routeToRegExp = function(route) {
      var escape_regexp;
      escape_regexp = /[\-{}\[\]+?.,\\\^$|#\s]/g;
      route = route.replace(escape_regexp, "\\$&").replace(param_regexp, param_replace).replace(splat_regexp, splat_replace).replace(/(\/|\b)$/, "\\/?");
    ...
    Cartograph.prototype.route = function(path, mixin) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        mapping = _ref[_i];
        if (match = this.scan(path, mapping.route, mapping)) {
          if (mixin != null) {
            params = mixin.params;
            delete mixin.params;
            for (key in mixin) {
  ...
  factory = function(EventSpitter) {
    ...
    return LoudAccessors = (function() {
      ...
      LoudAccessors.prototype.set = function(name, value, opts) {
        var _ref1;
        if ((_ref1 = this._attributes) == null) {
          this._attributes = {};
        }
  ...
  Submachine = (function() {
    ...
    Submachine.transition = function(obj) {
      ...
      return (_ref2 = (_base2 = this.prototype)[_name1 = obj.on]) != null ? _ref2 : _base2[_name1] = function() {
        var args, c, tr, _i, _len, _ref3, _results;
        args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
        ...
        for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
          ...
          if (this.state === tr.from || tr.from === "*") {
            c = typeof tr["if"] === "string" ? this[tr["if"]] : tr["if"];
            if (!(c != null) || c.call.apply(c, [this, tr.to].concat(__slice.call(args)))) {
